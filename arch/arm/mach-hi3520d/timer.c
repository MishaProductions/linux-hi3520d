...
void __init hi3520d_timerdev_initl(void)
{
    edb_trace();
...
void __init hi3520d_timerdev_init(struct device_node *np)
{
    ...
    clk[0] = clk_register_fixed_rate(NULL, "uart:0", NULL, CLK_IS_ROOT, uartclk);
    clk[1] = clk_register_fixed_rate(NULL, "uart:1", NULL, CLK_IS_ROOT, uartclk);
